import { Box, Button, Group, Select, Textarea, Space } from '@mantine/core';
...
export default function PromptPlaygroundForm() {
  ...
  const handleSubmit = async (values: FormValues) => {
    await submitWithPiiCheck(values.exampleInput, () => submitPrompt(values));
  };

  const submitPrompt = async (values: FormValues) => {
