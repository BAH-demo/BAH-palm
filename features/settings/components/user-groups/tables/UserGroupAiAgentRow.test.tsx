  ...
  describe('CERTA Agent', () => {
    ...
    it('renders requirement status when agent is CERTA', () => {
      ...
      const requirementText = screen.getByText(
        'AWS Bedrock Provider must be enabled for CERTA'
      );
    ...
    it('disables switch when AWS Bedrock provider is not available', () => {
      (useGetUserGroupAiProviders as jest.Mock).mockReturnValue({
        data: {
          userGroupProviders: [
            {
    ...
    it('enables switch when AWS Bedrock provider is available', () => {
      const bedrockProviderId = '123';
    ...
    it('disables switch when AWS Bedrock provider only exists in user group but not in main list', () => {
      (useGetUserGroupAiProviders as jest.Mock).mockReturnValue({
        data: {
          userGroupProviders: [
            {
